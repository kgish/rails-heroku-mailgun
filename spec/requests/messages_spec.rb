...
RSpec.describe 'Messages API', type: :request do
  ...
  let!(:messages) { create_list(:todo, 10) }
  let(:todo_id) { messages.first.id }
  ...
  describe 'PUT /messages/:id' do
    ...
    context 'when the record exists' do
      before { put "/messages/#{todo_id}", params: valid_attributes }
  ...
  describe 'DELETE /messages/:id' do
    before { delete "/messages/#{todo_id}" }
